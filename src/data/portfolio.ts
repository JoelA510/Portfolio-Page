...
export const PROJECTS: Project[] = [
  {
    ...
    aiStack: [
      ...
      { name: "Vitest", description: "200 tests gate every change; 122 more replay real shipments locally" },
    ],
    remediation:
